...
func GetHttp() *http.ServeMux {
    ...
    room_name := ""
    server.Handle("/static/", http.StripPrefix("/static/", http.FileServer(http.Dir("/local/usr/share/proj/files/static"))))

    server.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
        http.ServeFile(w, r, "/local/usr/share/proj/files/main.html")
    })
